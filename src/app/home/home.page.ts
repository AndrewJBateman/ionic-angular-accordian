...
export class HomePage {
	...
	public technologies: Array<{
	...
	}> = [
		{
			name: 'Angular',
			description:
				"Google's front-end development framework - default option for Ionic development",
		...
		},
		{
			name: 'VueJS',
			description:
				'Latest cutting edge front-end development framework - can be enabled as an option for Ionic development',
		...
		},
		{
			name: 'React',
			description:
				'Popular front-end development framework from Facebook- can be enabled as an option for Ionic development',
		...
		},
		{
			name: 'TypeScript',
			description:
				'Superset of JavaScript that provides class based object oriented programming and strict data typing',
		...
		},
		{
			name: 'Ionic Native',
			description:
				"Apache Cordova compatible plugins that allow native device API's to be utilised",
